	...
	namespace fragment_program
	{
		...
		public:
			...
			builder::expression_base_t decode_instruction()
			{
				...
				case (u32)opcode_t::pk4: return set_dst(float_point_expr<4>{ "packSnorm4x8(src(0));" });
				case (u32)opcode_t::up4: return set_dst(float_point_expr<4>{ "unpackSnorm4x8(src(0).x());" });
				...
				case (u32)opcode_t::pk2: return set_dst(float_point_expr<4>{ "packSnorm2x16(src(0).xy());" });
				case (u32)opcode_t::up2: return set_dst(float_point_expr<4>{ "unpackSnorm2x16(src(0).x());" });
				case (u32)opcode_t::pow: return set_dst(base::pow(src_swizzled_as_dst(0), src_swizzled_as_dst(1)), disable_swizzle_as_dst);
				case (u32)opcode_t::pkb: return set_dst(float_point_expr<4>{ "packUnorm4x8(src(0) / 255.);" });
				case (u32)opcode_t::upb: return set_dst(float_point_expr<4>{ "unpackUnorm4x8(src(0).x() * 255.);" });
				case (u32)opcode_t::pk16: return set_dst(float_point_expr<4>{ "packHalf2x16(src(0).xy());" });
				case (u32)opcode_t::up16: return set_dst(float_point_expr<4>{ "unpackHalf2x16(src(0).x());" });
